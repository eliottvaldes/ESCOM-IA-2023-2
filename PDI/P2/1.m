...
[veces, pixeles] = imhist(nombre);
   
figure(1)
subplot(1,1,1);
bar(pixeles,veces);
title("Histograma de mi nombre");
...
for i = 1:256
 ...
 for i = 1 : cantidad
     ...
     fprintf("\tPixel: %d \tProbabilidad: %f \tHufmann: %s\n", valores(i), tempProb(i), codificacionTemp(i));
...
%%format("long");
fprintf("\tLa eficiencia es de %f porciento\n", 100*entropia/sumLongitudes)